...
FRAME_THICKNESS = 3
FONT_THICKNESS = 2
MODEL = 'hog'  # default: 'hog' (Histogram of oriented gradients), other one can be 'cnn' - CUDA accelerated (if available) deep-learning pretrained model
...
for name in os.listdir(KNOWN_FACES_DIR):
    ...
    for filename in os.listdir(f'{KNOWN_FACES_DIR}/{name}'):
        ...
        print(str(len(face_recognition.face_encodings(image))))
